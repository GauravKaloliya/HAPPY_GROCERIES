...
class OrderService:
    ...
    def create_order(cls, user, cart, delivery_data):
        ...
        # Calculate applied discount amount (sum of individual item discounts)
        applied_discount_amount = sum(
            cart_item.product.discount_amount * cart_item.quantity
        ...
        for cart_item in cart_items:
            OrderItem.objects.create(
                ...
                applied_discount_amount=cart_item.product.discount_amount * cart_item.quantity,
