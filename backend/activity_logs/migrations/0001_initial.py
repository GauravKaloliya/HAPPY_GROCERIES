    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'created_at'], name='activity_log_user_created_idx'), models.Index(fields=['action', 'created_at'], name='act_log_act_created_idx'), models.Index(fields=['page'], name='activity_lo_page_104d88_idx'), models.Index(fields=['session_id'], name='activity_lo_session_45d5f6_idx'), models.Index(fields=['user'], name='activity_lo_user_id_072db3_idx')],
            },
        ),
    ]
