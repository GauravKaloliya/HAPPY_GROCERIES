# Generated manually - Initial seed data migration
...
def seed_products(apps, schema_editor):
    """Seed initial products matching legacy system exactly."""
    Category = apps.get_model('products', 'Category')
    ...
    for prod_data in products_data:
        ...
        # Set is_active to False for products with 0 stock (Soda)
        is_active = prod_data['stock'] > 0
...
def seed_coupons(apps, schema_editor):
    """Seed initial coupons matching legacy system."""
