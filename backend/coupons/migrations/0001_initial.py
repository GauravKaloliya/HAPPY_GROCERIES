    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'db_table': 'coupons',
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['code', 'is_active'], name='coupons_code_e67bf2_idx'), models.Index(fields=['is_active', 'valid_until'], name='coupons_is_acti_f29a31_idx'), models.Index(fields=['is_deleted'], name='coupons_is_dele_93fec4_idx')],
            },
        ),
        migrations.CreateModel(
            name='CouponUsage',
            ...
            options={
                ...
                'indexes': [models.Index(fields=['user'], name='coupon_usag_user_id_1c3309_idx'), models.Index(fields=['coupon'], name='coupon_usag_coupon__f4b516_idx'), models.Index(fields=['user', 'is_deleted'], name='coupon_usag_user_id_37d343_idx'), models.Index(fields=['coupon', 'is_deleted'], name='coupon_usag_coupon__f8649e_idx'), models.Index(fields=['is_deleted'], name='coupon_usag_is_dele_15a965_idx')],
